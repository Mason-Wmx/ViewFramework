...
=========================================================================*/
/**
 * @class   vtkExtSimOpenGLPolyDataMapper
 * @brief   PolyDataMapper using OpenGL to render.
 *
 * PolyDataMapper that uses a OpenGL to do the actual rendering.
*/

#ifndef vtkExtSimOpenGLPolyDataMapper_h
#define vtkExtSimOpenGLPolyDataMapper_h
...
class vtkExtSimOpenGLVertexBufferObject;
class vtkTextureObject;
class vtkTransform;
class vtkGenericOpenGLResourceFreeCallback;
class vtkExtSimValuePassHelper;

class SIMVTKEXT_EXPORT vtkExtSimOpenGLPolyDataMapper : public vtkPolyDataMapper
{
public:
  static vtkExtSimOpenGLPolyDataMapper* New();
  vtkTypeMacro(vtkExtSimOpenGLPolyDataMapper, vtkPolyDataMapper)
  ...
  vtkGetObjectMacro(VBO,vtkExtSimOpenGLVertexBufferObject);
...
protected:
  ...
  vtkExtSimOpenGLVertexBufferObject *VBO;
  ...
  vtkSmartPointer<vtkExtSimValuePassHelper> ValuePassHelper;
#endif
...
private:
  vtkExtSimOpenGLPolyDataMapper(const vtkExtSimOpenGLPolyDataMapper&) VTK_DELETE_FUNCTION;
  void operator=(const vtkExtSimOpenGLPolyDataMapper&) VTK_DELETE_FUNCTION;
};
