...
vtkStandardNewMacro(vtkExtSimValuePassHelper)

//------------------------------------------------------------------------------
class vtkExtSimValuePassHelper::vtkInternals
{
public:
...
////////////////////////////////////////////////////////////////////////////////
vtkExtSimValuePassHelper::vtkExtSimValuePassHelper()
...
//-----------------------------------------------------------------------------
void vtkExtSimValuePassHelper::ReleaseGraphicsResources(vtkWindow *win)
{
...
//-----------------------------------------------------------------------------
void vtkExtSimValuePassHelper::RenderPieceFinish()
{
...
//-----------------------------------------------------------------------------
void vtkExtSimValuePassHelper::RenderPieceStart(vtkActor* actor, vtkDataSet* input)
{
...
//-----------------------------------------------------------------------------
void vtkExtSimValuePassHelper::UpdateConfiguration(vtkRenderer* ren, vtkActor* act,
...
//-----------------------------------------------------------------------------
void vtkExtSimValuePassHelper::AllocateGraphicsResources(vtkRenderer* ren)
{
...
//-----------------------------------------------------------------------------
void vtkExtSimValuePassHelper::UpdateShaders(std::string & VSSource, std::string & FSSource,
  std::string & required)
{
...
//-----------------------------------------------------------------------------
void vtkExtSimValuePassHelper::BindAttributes(vtkOpenGLHelper& cellBO)
{
  if (this->Impl->CurrentDataArrayMode == VTK_SCALAR_MODE_USE_POINT_FIELD_DATA)
  {
    if (this->Impl->ValuePassArray)
...
//-----------------------------------------------------------------------------
void vtkExtSimValuePassHelper::BindUniforms(vtkOpenGLHelper& cellBO)
{
  if (this->Impl->CurrentDataArrayMode == VTK_SCALAR_MODE_USE_CELL_FIELD_DATA)
  {
...
//-----------------------------------------------------------------------------
bool vtkExtSimValuePassHelper::RequiresShaderRebuild()
{
...
// ----------------------------------------------------------------------------
void vtkExtSimValuePassHelper::PrintSelf(ostream& os, vtkIndent indent)
{
