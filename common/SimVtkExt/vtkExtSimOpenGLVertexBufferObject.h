...
=========================================================================*/
#ifndef vtkExtSimOpenGLVertexBufferObject_h
#define vtkExtSimOpenGLVertexBufferObject_h
...
class SIMVTKEXT_EXPORT vtkExtSimOpenGLVertexBufferObject :
  public vtkOpenGLBufferObject
{
public:
  static vtkExtSimOpenGLVertexBufferObject *New();
  vtkTypeMacro(vtkExtSimOpenGLVertexBufferObject, vtkOpenGLBufferObject);
  ...
  std::map<std::string, int> AttributesOffset;
  std::map<std::string, int> AttributesComponents;

  std::vector<float> PackedVBO; // the data

protected:
  vtkExtSimOpenGLVertexBufferObject();
  ~vtkExtSimOpenGLVertexBufferObject();
...
private:
  vtkExtSimOpenGLVertexBufferObject(const vtkExtSimOpenGLVertexBufferObject&) VTK_DELETE_FUNCTION;
  void operator=(const vtkExtSimOpenGLVertexBufferObject&) VTK_DELETE_FUNCTION;
};
